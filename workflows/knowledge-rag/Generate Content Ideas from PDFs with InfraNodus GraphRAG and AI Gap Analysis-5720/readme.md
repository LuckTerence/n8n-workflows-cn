...
> 原始来源：https://n8nworkflows.xyz/workflows/5720
...
| InfraNodus AI Questions | HTTP Request |
...
| InfraNodus GraphRAG AI Advice | HTTP Request |



## 功能说明

RAG 检索增强生成系统，基于文档向量库的知识问答（Content)表单提交触发，通过 HTTP API 实现自动化。
